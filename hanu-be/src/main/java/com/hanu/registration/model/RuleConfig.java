...
public class RuleConfig implements Serializable {
    ...
    public boolean isAvoidConflicts() {
        return avoidConflicts;
    }

    public void setAvoidConflicts(boolean avoidConflicts) {
        this.avoidConflicts = avoidConflicts;
    }

    public boolean isOnlyWhenOpen() {
        return onlyWhenOpen;
    }

    public void setOnlyWhenOpen(boolean onlyWhenOpen) {
        this.onlyWhenOpen = onlyWhenOpen;
    }
